...
public abstract class KrollObject implements Handler.Callback
{
	...
	protected abstract boolean fireEvent(KrollObject source, int typeIndex, String type, Object data, boolean bubbles, boolean reportSuccess, int code, String message);
